...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.PS is None:
        self.PS = [False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False]
      if self.DG is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_25B.pack(*self.PS))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.PS = _struct_25B.unpack(str[start:end])
