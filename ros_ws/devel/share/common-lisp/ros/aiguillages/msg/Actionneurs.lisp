...
(cl:defmethod cl:initialize-instance :after ((m <Actionneurs>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Actionneurs)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aiguillages-msg:<Actionneurs> is deprecated: use aiguillages-msg:Actionneurs instead.")))

(cl:ensure-generic-function 'actionneurs-val :lambda-list '(m))
(cl:defmethod actionneurs-val ((m <Actionneurs>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aiguillages-msg:actionneurs-val is deprecated.  Use aiguillages-msg:actionneurs instead.")
  (actionneurs m))
